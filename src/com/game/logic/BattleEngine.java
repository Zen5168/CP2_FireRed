...
public class BattleEngine {
    ...
    // ======================================
    // EXECUTE TURN (ORIGINAL - PRINTS TO CONSOLE)
    // ======================================
    ...
    // ======================================
    // EXECUTE TURN WITH RESULT (RETURNS MESSAGES)
    // ======================================
    public String executeTurnWithResult(Pokemon attacker, Pokemon defender, Moves move) {
        StringBuilder result = new StringBuilder();

        if (!move.useMove()) {
            result.append("But it missed!");
        ...
        if (typeEff > 1.0) {
            result.append("It's super effective!");
        } else if (typeEff < 1.0 && typeEff > 0) {
            result.append("It's not very effective...");
        } else if (typeEff == 0) {
            result.append("It had no effect...");
        }
