...
public class BattleUI {
    ...
    private void handleMainMenuInput(String input) {
        switch (input) {
            ...
            case "A":
                ...
                break;
            case "D":
                if (selectedOption % 2 == 0 && selectedOption < 3) selectedOption++;
                break;
            case "U": // Confirm
    ...
    private void handleFightMenuInput(String input) {
        ...
        switch (input) {
            case "W":
                ...
                break;
            case "S":
                if (selectedOption < 2 && selectedOption + 2 < moveCount) selectedOption += 2;
                break;
            case "A":
                if (selectedOption % 2 == 1) selectedOption--;
                break;
            case "D":
                if (selectedOption % 2 == 0 && selectedOption + 1 < moveCount) selectedOption++;
                break;
            case "U": // Confirm
    ...
    private void handleBagMenuInput(String input) {
        switch (input) {
            case "W":
                ...
                break;
            case "S":
                if (selectedOption < bagCategories.length - 1) selectedOption++;
                break;
            case "U": // Confirm
                enterBagItems();
                break;
    ...
    private void handleBagItemsInput(String input) {
        switch (input) {
            case "W":
                ...
                break;
            case "S":
                if (selectedOption < bagItems.size() - 1) selectedOption++;
                break;
            case "U": // Confirm
    ...
    private void handlePokemonMenuInput(String input) {
        ...
        switch (input) {
            case "W":
                ...
                break;
            case "S":
                if (selectedOption < partySize - 1) selectedOption++;
                break;
            case "U": // Confirm
    ...
    private void executePlayerMove(Moves move) {
        ...
        // DETERMINE TURN ORDER AND QUEUE ACTIONS
        ...
        // Actions will execute one by one as player presses buttons
        // checkBattleEnd will be called after each action
    }
    ...
    private void checkBattleEnd() {
        if (playerPokemon.isFainted()) {
            ...
            // DON'T CHANGE STATE HERE - Let nextDialogue() handle it after messages are shown
            // The state will remain BATTLE_ACTION and show dialogue until queue is empty
        }
    }
    ...
    private void nextDialogue() {
        // Check if we just displayed a move message (contains "used")
    ...
    private Color getTypeColor(Type type) {
        switch (type) {
            ...
            case NONE: return new Color(168, 168, 120);
            default: return new Color(168, 168, 120);
        }
    }
